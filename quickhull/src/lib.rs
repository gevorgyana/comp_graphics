...
use geo::{Line, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon};
...
// https://web.archive.org/web/20180409175413/http://www.ahristov.com/tutorial/geometry-games/convex-hull.html
...
mod test {
    use super::*;
    use geo::{line_string, polygon, Coordinate, Point};
